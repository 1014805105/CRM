...
public class TrainGradeDeleteServlet extends HttpServlet {
	private TrainGradeService traingradeService=new TrainGradeService();
	/**
	 * Constructor of the object.
	 */
	public TrainGradeDeleteServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int gradeid =Integer.parseInt(gradeids);
		System.out.println(gradeid);
		boolean flag = traingradeService.deleteTrainGrade(gradeid);
