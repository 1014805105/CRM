...
public class TrainRecordDeleteServlet extends HttpServlet {
	private TrainRecordService trainrecordService =new TrainRecordService();
	/**
	 * Constructor of the object.
	 */
	public TrainRecordDeleteServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Integer trainid=Integer.parseInt(trainidS);
		System.out.println(trainid);
		boolean flag = trainrecordService.deleteTrainRecord(trainid);
