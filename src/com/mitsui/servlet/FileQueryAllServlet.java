...
public class FileQueryAllServlet extends HttpServlet {
	private FileService fileService = new FileService();
	/**
	 * Constructor of the object.
	 */
	public FileQueryAllServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/view/files/filequery.jsp").forward(request,response);
	}
