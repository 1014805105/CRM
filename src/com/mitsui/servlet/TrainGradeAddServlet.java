...
public class TrainGradeAddServlet extends HttpServlet {
	private TrainGradeService traingradeService=new TrainGradeService();
	/**
	 * Constructor of the object.
	 */
	public TrainGradeAddServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		TrainGrade gradeob=new TrainGrade(null, trainid, pid, grade, subject,null);
		System.out.println(gradeob);
		boolean flag = traingradeService.addTrainGrade(gradeob);
