...
public class TrainTypeAddServlet extends HttpServlet {
	TrainTypeService traintypeservice=new TrainTypeService();

	/**
	 * Constructor of the object.
	 */
	//private TrainTypeService traintypeService=new TrainTypeService();
	public TrainTypeAddServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		boolean flag = traintypeservice.addTrainType(type);
