...
public class StaffCertAddServlet extends HttpServlet {
	private StaffCertService staffcertService=new StaffCertService();
	/**
	 * Constructor of the object.
	 */
	public StaffCertAddServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		StaffCert cert=new StaffCert(null, gradeid, cername, cerdate);
		System.out.println(cert);
		boolean flag = staffcertService.addStaffCert(cert);
