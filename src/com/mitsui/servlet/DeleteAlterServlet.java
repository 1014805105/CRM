...
public class DeleteAlterServlet extends HttpServlet {
	private AlterService userService = new AlterService();
	/**
	 * Constructor of the object.
	 */
	public DeleteAlterServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//System.out.println(alter_id);
		boolean flag = userService.deleteAlter(Integer.valueOf(alter_id));
		if(flag){
