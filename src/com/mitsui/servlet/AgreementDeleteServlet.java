...
public class AgreementDeleteServlet extends HttpServlet {
	private AgreementService agreementService = new AgreementService();

	/**
	 * Constructor of the object.
	 */
	public AgreementDeleteServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean flag = agreementService.deleteAgreement(Integer.parseInt(agreement_id));
		if (flag) {
